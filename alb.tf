...
module "alb" {
  ...
  https_listener_rules = [
    # Rule-1: var.route53_app1_dns_name forward to ec2_private_app1
    { 
      ...
      conditions = [{
        host_headers = [var.route53_app1_dns_name]
      }]
    },
    # Rule-2: var.route53_app2_dns_name forward to ec2_private_app2
    {
      https_listener_index = 0
      actions = [
        {
      ...
      conditions = [{
        host_headers = [var.route53_app2_dns_name]
      }]
    },    
  ]
